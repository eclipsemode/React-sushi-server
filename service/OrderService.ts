...
type FrontpadStatusType = 1 | 3 | 13 | 12 | 4 | 11 | 10;
type FrontpadActionType = 'change_status';

class OrderService {
    async create({userId, orderId, totalPrice, totalAmount, type, name, address, entrance, floor, room, tel, email, day, time, utensils, payment, commentary, promocode, status, products, branchId}: IOrder) {
    ...
    async changeStatusWebhook(action: FrontpadActionType, order_id: number, status: FrontpadStatusType, datetime: string) {
